...
<<<<<<< HEAD:src/main/java/gatedcommunity/controller/PropositionServiceController.java
=======
...
>>>>>>> origin/dev:src/main/java/projectfs44/gatedcommunity/controller/PropositionServiceController.java
    @GetMapping("/{id}")
