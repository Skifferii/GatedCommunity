...
UserResponseDTO {
    ...
    public UserResponseDTO(Long id, String picture, long propositionServiceId, String propositionServiceTitle, String description, LocalDateTime desiredDateTime, long userId, long addressId, boolean active) {
        this.id = id;
        this.picture = picture;
        this.propositionServiceId = propositionServiceId;
        this.propositionServiceTitle = propositionServiceTitle;
